...
export class DbGetProdutividadeByCenter implements GetProdutividadeByCenterAndData {
  constructor(
    private readonly getProdutividade: GetProdutividadeByCenterAndDataRepository
  ) {}

  async getProdutivicidade(params: GetProdutividadeByCenterAndData.Params): Promise<GetProdutividadeByCenterAndData.Result[]> {
