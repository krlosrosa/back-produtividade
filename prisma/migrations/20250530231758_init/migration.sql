...
INSERT INTO "new_DadosTransporte" ("caixas", "centerId", "empresa", "horaFim", "horaInicio", "id", "processo", "transporte", "unidade", "userId", "visitado") SELECT "caixas", "centerId", "empresa", "horaFim", "horaInicio", "id", "processo", "transporte", "unidade", "userId", "visitado" FROM "DadosTransporte";
